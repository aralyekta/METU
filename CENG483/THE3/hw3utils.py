...
class HW3ImageFolder(torchvision.datasets.ImageFolder):
    ...
    def __getitem__(self, index):
        ...
        return self.prepimg(grayscale_image).to(self.device), self.prepimg(color_image).to(self.device), path

# class HW3GrayscaleImageFolder(torchvision.datasets.ImageFolder):
#     """A version of the ImageFolder dataset class, customized for the super-resolution task"""

#     def __init__(self, root, device):
#         super(HW3GrayscaleImageFolder, self).__init__(root, transform=None)
#         self.device = device
...
#         ############################################################################################################
#         """
#         grayscale_image,_ = super(HW3GrayscaleImageFolder, self).__getitem__(index) # Image object (PIL)
#         return self.prepimg(grayscale_image).to(self.device)
