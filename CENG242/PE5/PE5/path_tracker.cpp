...
{
    float calculated_displacement = calculate_l2(final_x, final_y, 0, 0);
    return calculated_displacement;
}
...
{
    float calculated_distance = calculate_l2(x + final_x, y + final_y, final_x, final_y);
