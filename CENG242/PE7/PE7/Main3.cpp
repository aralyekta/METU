...
int main() {
	...
	nm1->setDataToNode(10, 'A');
	nm2->addRelation(10, 2);
	//nm2->setDataToNode(10, 'A');
	const Node& root1 = nm1->getNode(10);
	const Node& root2 = nm2->getNode(10);
	cout << root1 << "\n";
	cout << root2 << "\n";
	...
	nm1->setDataToNode(1235, 'A');
	nm1->setDataToNode(100, 'H');
	nm1->setDataToNode(1, 'C');
	nm1->setDataToNode(7, 'G');
