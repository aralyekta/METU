...
int main()
{
	long comparison = 0, comparison2 = 0, swap = 0;
	int arr1[8] = {0, -5, 2, 6, 4, 18, 22, -14};
	int arr2[8] = {0, -5, 2, 6, 4, 18, 22, -14};
	int size = 8;
	srandom(time(0));
	int num= sillySort(arr1, comparison, swap, size);
	int num2 = crossMergeSort(arr2, comparison2, size);
	for (int i = 0; i < size; i++) {
		cout << arr1[i] << " ";
	}
	cout << "\n";
	...
	cout << "\n";
	cout << num2 << " " << comparison2 << "\n";
	cout << num << " " << comparison << " " << swap << "\n";
