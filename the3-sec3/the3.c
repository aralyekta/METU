...
int main()
{
	...
	int interval_amount, i, j, letter_amount, temp;
	long int experiment_amount;
	...
	*/
	/*find_random(1.5, 2.5);*/
	/* Fonklarda hep bunu kullanacağız
	 * nan veya inf gelirse sayma, bir daha yap diyebiliriz
